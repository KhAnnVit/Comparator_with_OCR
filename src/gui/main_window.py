...
class App(ctk.CTk):
    ...
    def _global_ctrl_keypress(self, event=None):
        ...
        Зачем нужен:
        - на английской раскладке стандартные Ctrl+C / Ctrl+V / Ctrl+X / Ctrl+A / Ctrl+Z
          обычно обрабатываются самим Tkinter;
        - на русской раскладке стандартные биндинги могут не сработать,
          потому что символ клавиши другой;
        - поэтому английскую раскладку не трогаем, чтобы не было двойной вставки,
          а русскую обрабатываем через физический keycode.
        ...
        # Если раскладка английская, ничего вручную не делаем.
        # Иначе стандартный Tkinter + наш обработчик могут выполнить действие дважды.
        if keysym in {"a", "c", "v", "x", "z"}:
            return

        # Если раскладка русская или другая, используем физический код клавиши.
